            ...
            <Container>
                <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
                    ...
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        ...
                        <p className="mb-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. A labore itaque impedit? Quia sit atque, inventore soluta sed itaque esse, enim dolor impedit eos ut sint similique rerum illo tempora!</p>
